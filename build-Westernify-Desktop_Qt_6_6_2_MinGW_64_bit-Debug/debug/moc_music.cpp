...
#include "../../Westernify/PlayWidget/music.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMusicENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMusicENDCLASS_t qt_meta_stringdata_CLASSMusicENDCLASS = {
    {
        QT_MOC_LITERAL(0, 5),  // "Music"
        QT_MOC_LITERAL(6, 12),  // "songFinished"
        QT_MOC_LITERAL(19, 0)   // ""
    },
    "Music",
    "songFinished",
...
void Music::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Music::*)();
            if (_t _q_method = &Music::songFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
